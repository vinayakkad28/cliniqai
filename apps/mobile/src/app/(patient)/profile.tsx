...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#1d4ed8', padding: 24, alignItems: 'center', paddingTop: 16 },
  ...
  abhaNumber: { fontSize: 13, color: '#fff', fontFamily: 'monospace' },
  section: { padding: 16 },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: '#1f2937', marginBottom: 8 },
  card: { backgroundColor: '#fff', borderRadius: 12, overflow: 'hidden' },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  infoLabel: { fontSize: 13, color: '#6b7280' },
  infoValue: { fontSize: 13, fontWeight: '500', color: '#1f2937', maxWidth: '60%', textAlign: 'right' },
  menuItem: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  menuLabel: { flex: 1, fontSize: 14, color: '#1f2937' },
